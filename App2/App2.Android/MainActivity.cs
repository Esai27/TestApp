...
namespace App2.Droid
{
    ...
    public class MainActivity : global::Xamarin.Forms.Platform.Android.FormsAppCompatActivity
    {
        ...
        internal static readonly int NOTIFICATION_ID = 87;
        ...
        void CreateNotificationChannel()
        {
            ...
            var notificationManager = (Android.App.NotificationManager)GetSystemService(Android.Content.Context.NotificationService);
